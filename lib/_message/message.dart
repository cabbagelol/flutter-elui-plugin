...
class EluiMessageComponentWidget extends StatefulWidget {
  ...
  EluiMessageComponentWidget({key, this.color, this.align, @required this.child}) : super(key: key);

  @override
  EluiMessageComponentWidgetState createState() => EluiMessageComponentWidgetState();
}

class EluiMessageComponentWidgetState extends State<EluiMessageComponentWidget> with TickerProviderStateMixin {
